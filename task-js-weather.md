...
Макет приложения:
[Макет в Figma](https://www.figma.com/file/pG3gba6cOUgbTtleMa9dE5/weather-app)
...
- Реализованы юнит-тесты, использующие различные [методы jest](https://jestjs.io/docs/ru/expect) – 2 балла за каждую покрытую функию/метод, но не больше (процент покрытия каждой функции/метода не учитывается) - ВТОРОЙ ЭТАП

### Hacker scope - ВТОРОЙ ЭТАП

- Реализовано голосовое управление/уведомление
...
- Перевод текста страницы (en/ru/be)
